...
- **F3: Navigation.** Sticky nav across all pages: Home, About, Discord, Invests, Links, Projects, YouTube, GitHub, Support. Active state via `class="active"` in HTML. Nav collapses on mobile. Discord links to `discord.html`; GitHub links to `github.com/Azqato`, both opening in the same tab.
