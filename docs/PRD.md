...
| v3.32.0 — Pipeline cleanup (delete legacy FMP_API_KEY secret from repo settings, owner step; reclassify data-files-in-git from tech debt to intentional score-history design) | After v3.31 | Planned |
