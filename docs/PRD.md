...
**v4.x (order updated 2026-07-04):** v4.0.0 screener responsive redesign & site-wide mobile-friendliness pass shipped 2026-07-04, v4.1.0 score history sparklines next, v4.2.0 deeper index fund coverage, v4.3.0 additional historical illustrative examples, v4.4.0 additional philosophy sections, v4.5.0 conference call research guide. Potential Growth/Value/Dividend standalone framework pages remain unversioned backlog.
