...
When auditing for em dashes, all three forms must be checked: the double hyphen, the raw Unicode em dash (U+2014), and the HTML entity.
...
- **Section 4 (Content Philosophy):** Punctuation policy statement updated to explicitly name all three em dash forms to audit: double hyphen, raw Unicode, and HTML entity
- **Punctuation style guide:** New "Audit checklist" block added at the top of the section, listing all three search targets with notes that the HTML entity form is especially easy to miss in HTML source
